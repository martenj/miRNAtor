 ...
 */
public class Mre {
	/** the Mirna the MRE is related to */
	private Mirna mirna;
	/** the sequence the MRE is related to */
	private Sequence sequence;
	/** the '0'-based start on the {@link Sequence} */
	private int sequence_start;
	/** the '0'-based end on the {@link Sequence} */
	private int sequence_end;
	/** the '0'-based start on the {@link Mirna} */
	private int mirna_start;
	/** the '1'-based end on the {@link Mirna} */
	private int mirna_end;
	/** the {@link MREtype} of the MRE */
	private MREtype type;
	/**
	 * the conservation of the MRE in respect to the genomic position - only possible if the sequence is coneted to a
	 * database transcript
	 */
	private double conservation;
	/** the free energy for the miRNA<->sequence interaction */
	private double free_energy;
	...
	/**
	 * Sets the conservation score for this {@link Mirna} <-> {@link Sequence} interaction. This should only be used if
