 ...
 *
 */
public enum MREtypeConstant {
	SEVEN_A1, SEVEN_M8, EIGHT, SIX, OFFSET_SIX, COMPENSATORY17, COMPENSATORY28, COMPENSATORY18, EIGHT_A1, MIRBASESPECIFIC, SEVEN_M1, FIVE_BULG_FOUR, SIX_BULG_FIVE, SEVEN_BULG_SIX, BULG_A, BULG_C, BULG_G, BULG_U;
	 ...
	 */
	public String getShortName(MREtypeConstant m) {
		String shortName;
		switch (m) {
		case SEVEN_A1:
			shortName = "7a1"; // 0
	 ...
	 * @return MRE group
	 */
	public static int getMreGroup(MREtypeConstant m) {
		switch (m) {
		case SEVEN_A1:
			return (1); // 0
		case SEVEN_M8:
	 ...
	 */
	public String getDescription(MREtypeConstant m) {
		String description;
		switch (m) {
		case SEVEN_A1:
